/* Turni & Accessorio PS — Service Worker V113 (v2.39.0 — assenza personalizzata modificabile, assenze/statistiche compatte, cedolino in fondo) */
'use strict';
const CACHE='turni-ps-v113';
const APP_SHELL=[
